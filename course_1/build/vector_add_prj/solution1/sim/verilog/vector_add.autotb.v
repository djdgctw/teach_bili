...
`define AUTOTB_DUT      vector_add
`define AUTOTB_DUT_INST AESL_inst_vector_add
`define AUTOTB_TOP      apatb_vector_add_top
`define AUTOTB_LAT_RESULT_FILE "vector_add.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "vector_add.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_vector_add_top
...
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.vector_add.autotvin_gmem0.dat"
`define AUTOTB_TVIN_a_out_wrapc  "../tv/rtldatafile/rtl.vector_add.autotvin_a.dat"
`define AUTOTB_TVIN_c_out_wrapc  "../tv/rtldatafile/rtl.vector_add.autotvin_c.dat"
`define AUTOTB_TVIN_size_out_wrapc  "../tv/rtldatafile/rtl.vector_add.autotvin_size.dat"
`define AUTOTB_TVOUT_gmem1  "../tv/cdatafile/c.vector_add.autotvout_gmem1.dat"
`define AUTOTB_TVOUT_gmem1_out_wrapc  "../tv/rtldatafile/rtl.vector_add.autotvout_gmem1.dat"
module `AUTOTB_TOP;
