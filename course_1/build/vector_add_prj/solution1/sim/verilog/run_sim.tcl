...
if {[file isfile vector_add.autotvin.dat]} {
	file delete -force vector_add.autotvin.dat
}

if {[file isfile vector_add.autotvout.dat]} {
	file delete -force vector_add.autotvout.dat
}
