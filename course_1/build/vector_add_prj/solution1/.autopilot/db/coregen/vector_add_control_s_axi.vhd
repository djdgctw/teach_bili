...
entity vector_add_control_s_axi is
generic (
...
end entity vector_add_control_s_axi;
...
architecture behave of vector_add_control_s_axi is
    ...
    constant ADDR_C_DATA_0    : INTEGER := 16#1c#;
    constant ADDR_C_DATA_1    : INTEGER := 16#20#;
