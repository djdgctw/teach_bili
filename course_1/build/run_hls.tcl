...
open_project vector_add_prj

# 设置顶层函数名为vector_add（即要综合的主函数）
set_top vector_add

# 添加设计源文件vector_add.cpp到项目中（从code目录）
add_files ../code/vector_add.cpp

# 添加头文件vector_add.h到项目中（从code目录）
add_files ../code/vector_add.h

# 添加测试文件main.cpp，并设置编译和链接选项：
# 即使不直接使用OpenCV，但OpenCV环境可能解决cout的cosim问题
