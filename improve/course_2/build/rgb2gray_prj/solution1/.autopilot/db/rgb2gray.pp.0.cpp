...
__attribute__((sdx_kernel("rgb2gray", 0))) void rgb2gray(const ap_uint<24> *rgb, ap_uint<8> *gray, int size);
# 2 "../code/rgb2gray.cpp" 2

__attribute__((sdx_kernel("rgb2gray", 0))) void rgb2gray(const ap_uint<24> *rgb, ap_uint<8> *gray, int size) {
#line 53 "/home/fyt/A/teach_bili/improve/course_2/build/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=rgb2gray
# 3 "../code/rgb2gray.cpp"
...
#pragma HLS INTERFACE s_axilite port=return bundle=control
 VITIS_LOOP_10_1: for (int i = 0; i < size; i++) {
