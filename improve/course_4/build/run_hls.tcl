...
puts "Gaussian Blur HLS Project - Start time: [clock format [clock seconds]]"
...
# 设置顶层函数名为gaussian_blur（即要综合的主函数）
set_top gaussian_blur

# 添加设计源文件gaussian_blur.cpp到项目中（从code目录）
add_files ../code/gaussian_blur.cpp

# 添加头文件gaussian_blur.h到项目中（从code目录）
add_files ../code/gaussian_blur.h
