...
puts "Histogram Equalization HLS Project - Start time: [clock format [clock seconds]]"
...
# ============ HLS项目配置部分 ============
# 打开或创建HLS项目，项目名为histogram_eq_prj
open_project histogram_eq_prj

# 设置顶层函数名为histogram_eq（即要综合的主函数）
set_top histogram_eq

# 添加设计源文件histogram_eq.cpp到项目中（从code目录）
add_files ../code/histogram_eq.cpp

# 添加头文件histogram_eq.h到项目中（从code目录）
add_files ../code/histogram_eq.h
