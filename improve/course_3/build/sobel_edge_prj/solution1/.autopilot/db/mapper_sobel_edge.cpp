...
using hls::sim::Byte;
extern "C" void sobel_edge(Byte<1>*, Byte<1>*, int, int, int, int);
extern "C" void apatb_sobel_edge_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r, int __xlx_apatb_param_rows, int __xlx_apatb_param_cols) {
...
__xlx_input_r__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_input_r)[i]);
  ...
  int __xlx_size_param_input_r = 4096;
...
__xlx_output_r__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_output_r)[i]);
  ...
  int __xlx_size_param_output_r = 4096;
  int __xlx_offset_param_output_r = 0;
  int __xlx_offset_byte_param_output_r = 0*1;
  // DUT call
  sobel_edge(__xlx_input_r__tmp_vec.data(), __xlx_output_r__tmp_vec.data(), __xlx_offset_byte_param_input_r, __xlx_offset_byte_param_output_r, __xlx_apatb_param_rows, __xlx_apatb_param_cols);
