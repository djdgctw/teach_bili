set moduleName sobel_edge_Pipeline_VITIS_LOOP_37_5
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {sobel_edge_Pipeline_VITIS_LOOP_37_5}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "sext_ln39", "interface" : "wire", "bitwidth" : 33, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln16 sc_in sc_lv 32 signal 2 } 
	{ output_r sc_in sc_lv 64 signal 3 } 
	{ sext_ln39 sc_in sc_lv 33 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln39", "direction": "in", "datatype": "sc_lv", "bitwidth":33, "type": "signal", "bundle":{"name": "sext_ln39", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln39 { ap_none {  { sext_ln39 in_data 0 33 } } }
}
