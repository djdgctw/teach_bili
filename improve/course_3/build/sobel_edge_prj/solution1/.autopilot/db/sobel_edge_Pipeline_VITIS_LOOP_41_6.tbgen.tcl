set moduleName sobel_edge_Pipeline_VITIS_LOOP_41_6
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {sobel_edge_Pipeline_VITIS_LOOP_41_6}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem1 int 8 regular {axi_master 1}  }
	{ cols int 32 regular  }
	{ output_r int 64 regular  }
	{ add_ln43 int 64 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "add_ln43", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ add_ln43 sc_in sc_lv 64 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln43", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "add_ln43", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	add_ln43 { ap_none {  { add_ln43 in_data 0 64 } } }
}
