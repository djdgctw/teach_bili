...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_ln24 \
    op interface \
    ports { add_ln24 { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_ln24_6 \
    op interface \
    ports { add_ln24_6 { I 64 vector } } \
} "
}
...
set InstName sobel_edge_flow_control_loop_pipe_sequential_init_U
set CompName sobel_edge_flow_control_loop_pipe_sequential_init
