...
if {[file isfile sobel_edge.autotvin.dat]} {
	file delete -force sobel_edge.autotvin.dat
}

if {[file isfile sobel_edge.autotvout.dat]} {
	file delete -force sobel_edge.autotvout.dat
}
