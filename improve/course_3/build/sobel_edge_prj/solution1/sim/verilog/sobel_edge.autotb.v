...
`define AUTOTB_DUT      sobel_edge
`define AUTOTB_DUT_INST AESL_inst_sobel_edge
`define AUTOTB_TOP      apatb_sobel_edge_top
`define AUTOTB_LAT_RESULT_FILE "sobel_edge.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "sobel_edge.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_sobel_edge_top
...
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.sobel_edge.autotvin_gmem0.dat"
`define AUTOTB_TVIN_input_r_out_wrapc  "../tv/rtldatafile/rtl.sobel_edge.autotvin_input_r.dat"
`define AUTOTB_TVIN_output_r_out_wrapc  "../tv/rtldatafile/rtl.sobel_edge.autotvin_output_r.dat"
`define AUTOTB_TVIN_rows_out_wrapc  "../tv/rtldatafile/rtl.sobel_edge.autotvin_rows.dat"
`define AUTOTB_TVIN_cols_out_wrapc  "../tv/rtldatafile/rtl.sobel_edge.autotvin_cols.dat"
`define AUTOTB_TVOUT_gmem1  "../tv/cdatafile/c.sobel_edge.autotvout_gmem1.dat"
`define AUTOTB_TVOUT_gmem1_out_wrapc  "../tv/rtldatafile/rtl.sobel_edge.autotvout_gmem1.dat"
module `AUTOTB_TOP;
