...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.sobel_edge.autotvin_gmem0.dat"
         "c.sobel_edge.autotvin_input_r.dat"
         "c.sobel_edge.autotvin_output_r.dat"
         "c.sobel_edge.autotvin_rows.dat"
         "c.sobel_edge.autotvin_cols.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.sobel_edge.autotvout_gmem1.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
