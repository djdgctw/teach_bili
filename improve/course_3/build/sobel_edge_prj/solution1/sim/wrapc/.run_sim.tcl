...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "sobel_edge.autotvin.dat"
	set constFileTvOut       "sobel_edge.autotvout.dat"
	set constFileHdlTvIn     "sobel_edge.autohdltvin.dat"
	set constFileHdlTvOut    "sobel_edge.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
