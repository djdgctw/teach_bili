...
puts "Threshold Binarization HLS Project - Start time: [clock format [clock seconds]]"
...
# ============ HLS项目配置部分 ============
# 打开或创建HLS项目，项目名为threshold_prj
open_project threshold_prj

# 设置顶层函数名为threshold（即要综合的主函数）
set_top threshold

# 添加设计源文件threshold.cpp到项目中（从code目录）
add_files ../code/threshold.cpp

# 添加头文件threshold.h到项目中（从code目录）
add_files ../code/threshold.h
