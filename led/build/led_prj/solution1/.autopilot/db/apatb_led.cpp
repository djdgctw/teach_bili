...
// wrapc file define:
#define AUTOTB_TVIN_key_t "../tv/cdatafile/c.led.autotvin_key_t.dat"
#define AUTOTB_TVOUT_key_t "../tv/cdatafile/c.led.autotvout_key_t.dat"
#define AUTOTB_TVIN_led "../tv/cdatafile/c.led.autotvin_led.dat"
#define AUTOTB_TVOUT_led "../tv/cdatafile/c.led.autotvout_led.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_led "../tv/rtldatafile/rtl.led.autotvout_led.dat"
...
extern "C"
void led_hw_stub_wrapper(hls::sim::Byte<1>*, void*);

extern "C"
void apatb_led_hw(hls::sim::Byte<1>* __xlx_apatb_param_key_t, void* __xlx_apatb_param_led)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_key_t),
#endif
  };
  port0.param = __xlx_apatb_param_key_t;

  static hls::sim::Register port1 {
    .name = "led",
    .width = 4,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_led),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_led),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_led),
#endif
  };
  port1.param = __xlx_apatb_param_led;
  ...
  try {
    ...
    led_hw_stub_wrapper(__xlx_apatb_param_key_t, __xlx_apatb_param_led);
